...
CREATE TABLE Comentario(
	...
	CONSTRAINT			FK_UserName FOREIGN KEY(UserNameComent) REFERENCES Usuario(UserName),
	CodComent			INT			NOT NULL,
	CONSTRAINT			PK_CodComent	PRIMARY KEY(CodComent),
	DataPost			DATE		NOT NULL,
	TextoComentario		VARCHAR(950)NOT NULL,
	ContComentCod		INT			NOT NULL,
	CONSTRAINT			FK_ContCodComent FOREIGN KEY (ContComentCod) REFERENCES Conteudo(ContCod)
)
